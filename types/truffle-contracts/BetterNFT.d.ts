...
export interface BetterNFTContract extends Truffle.Contract<BetterNFTInstance> {
  "new"(
    name: string,
    symbol: string,
    baseURI: string,
    meta?: Truffle.TransactionDetails
  ): Promise<BetterNFTInstance>;
}
...
export interface BetterNFTInstance extends Truffle.ContractInstance {
